...
export default function Footer() {
  ...
  // Updated social links with real URLs (replace with actual social media URLs)
  const socialLinks = [
    {
      icon: FaFacebookSquare,
      name: "Facebook",
      color: "hover:text-blue-500",
      link: "https://facebook.com/ukfoutlets", // Replace with actual Facebook URL
    ...
    },
    {
      ...
      link: "https://twitter.com/ukfoutlets", // Replace with actual Twitter URL
    ...
    },
    {
      ...
      link: "https://instagram.com/ukfoutlets", // Replace with actual Instagram URL
      hoverBg:
    ...
    },
    {
      ...
      link: "https://linkedin.com/company/ukfoutlets", // Replace with actual LinkedIn URL
  ...
  const companyLinks = [
    ...
    { name: "Plans & Offers", href: "/onsale" },
  ];

  const helpLinks = [
    { name: "FAQ", href: "/faq" },
    { name: "Support Center", href: "/contactus" },
  ];
            ...
            <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-8 lg:gap-12">
              ...
              <div className="space-y-6 group">
                <div className="transform transition-all duration-500 group-hover:scale-105">
                  <img width={200} src={logo} alt="UKF Outlets Logo" />
                </div>
                ...
                <p className="text-gray-300 leading-relaxed text-sm md:text-base transform transition-all duration-300 hover:text-[#FFD700]">
                  ...
                  stunning digital experiences. We understand your brand, your
                  vibe, and your audience—then design every detail to reflect
                  your style. From concept to creation, we use thoughtful design
                  and smart tech to elevate your fashion business.
                </p>
                ...
                <div className="flex items-center gap-4">
                  {socialLinks.map((social, index) => (
                    ...
                    >
                      <button
                        onClick={() => handleExternalLink(social.link)}
                        className={`p-3 rounded-xl bg-gradient-to-br from-gray-800 to-gray-900 border border-[#FFD700]/20 text-[#FFD700] transition-all duration-300 transform hover:scale-110 hover:-translate-y-1 hover:shadow-lg hover:shadow-[#FFD700]/20 ${social.color} ${social.hoverBg} flex items-center justify-center cursor-pointer`}
                      >
                      ...
                      {/* Tooltip */}
                      <div
                        className={`absolute -top-12 left-1/2 transform -translate-x-1/2 px-3 py-1 bg-black text-[#FFD700] text-xs rounded-lg border border-[#FFD700]/30 transition-all duration-300 ${
                          hoveredSocial === index
                ...
                <nav className="space-y-3">
                  {companyLinks.map((link, index) => (
                    <div
                      ...
                      className="block text-gray-300 hover:text-[#FFD700] transition-all duration-300 transform hover:translate-x-2 hover:scale-105 py-1 px-2 rounded-lg hover:bg-[#FFD700]/5 group cursor-pointer"
                    >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-4 text-gray-300 p-3 rounded-xl group">
                    ...
                    <span className="font-medium">
                      J45P+XQX, In side, chandpol, gate, Subhash Chowk, Sikar,
                      Rajasthan 332001
                    </span>
                  </div>
                </div>
            ...
            <div className="mt-16 pt-8 border-t border-[#FFD700]/20">
              <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                <div className="flex items-center gap-2 text-gray-300">
                  ...
                  <span>
                    ...
                    <a
                      ...
                      className="text-[#ecba49] cursor-pointer hover:text-yellow-300 transition-colors duration-300 relative z-10"
                    >
                      TechBro24
                    </a>
                  </span>
                ...
                <div className="flex gap-6 text-sm">
                  <button
                    onClick={() => {
                      console.log("Privacy Policy clicked"); // Debug log
                      navigate("/policy");
                    }}
                    className="text-gray-300 cursor-pointer hover:text-[#FFD700] transition-colors duration-300 hover:underline bg-transparent border-none p-2 relative z-10"
                  >
                    Privacy Policy
                  </button>
                  <button
