...
const Navbar = () => {
  ...
  return (
    ...
    <div className="bg-black h-[10vh] text-[#FFD700] flex items-center justify-between px-3 lg:px-10 ">
         ...
         <img src={logo} className="w-[10vh] ml-10 cursor-pointer lg:ml-0" onClick={()=>navigate('/Home')} alt="UKF-Outlets" />
        ...
        <div className="hidden opacity-0 lg:opacity-100 lg:flex">
            <ul className="flex gap-5">
                <li className="group flex flex-col justify-between relative">
                    ...
                    <div className="opacity-0 group-hover:opacity-100 w-[4vw] h-[1px] bg-[#FFD700]">
                    </div>
        ...
        <div  className=" relative">
            <FaSearch onClick={()=>setShowSearch(!showSearch)} />
            {
                ...
                <div className=" absolute  top-11  left-[-71vw] lg:left-[-1404px] z-[102] shadow-2xl w-[100vw] pb-10 bg-[#FFD700]">
                    ...
                    <div onClick={()=>setShowSearch(false)} className="text-red-500 hidden  cursor-pointer absolute top-2 w-[25px] h-[25px] lg:flex justify-center items-center  right-5 border-4 border-red-500 font-bold  rounded-full">x</div>
                        <div className="flex gap-0 ">
                            <input type="text" placeholder="Search..." onChange={(e)=>setSearchBar(e.target.value)} className="bg-black h-[8vh]  pl-4 text-[#ffd700] placeholder:text-[#FFD700] lg:w-[50vw] border-black rounded-l-2xl" />
                            <button className="bg-black h-[8vh] w-[15vw] lg:w-[5vw] flex justify-center items-center rounded-r-2xl " onClick={searchHandler}><FaSearch /></button>
                        </div>
                    </div>
                        ...
                        <div className="flex flex-col gap-5 lg:flex-row lg:justify-center lg:w-[100vw]">
                            <div className="flex justify-around ">
                                <div className="w-[40vw] lg:w-[20vw] flex flex-col items-center ">
                                    <div>
                                        <img src={womensfashion} alt="image1" className="rounded-2xl mb-2 shadow-2xl h-[25vh] lg:w-[23vh]" />
                                    </div>
                                ...
                                <div className="w-[40vw] lg:w-[20vw] flex flex-col items-center ">
                                     <div>
                                        <img src={mensfashion} alt="image2" className="rounded-2xl mb-2 shadow-2xl h-[25vh] lg:w-[23vh]" />
                                    </div>
                                    <div className="text-xs">
                                        Men's Fashion
                                    </div>
                            ...
                            <div className="flex justify-around">
                                <div className="w-[40vw] lg:w-[20vw] flex flex-col items-center ">
                                    <div>
                                        <img src={perfumes} alt="image3" className="rounded-2xl mb-2 shadow-2xl h-[25vh]" />
                                    </div>
                                    <div className="text-xs">
                                        Perfumes
                                    </div>
                                ...
                                <div className="w-[40vw] lg:w-[20vw] flex flex-col items-center ">
                                     <div>
                                        <img src={accessories} alt="image2" className="rounded-2xl mb-2 shadow-2xl h-[25vh]" />
                                    </div>
                                    <div className="text-xs">
                                        Accessories
                                    </div>
  ...
  <div className="absolute opacity-0 pointer-events-none w-[150px] h-[150px] bg-[#FFD700] z-[100] left-[-70px] top-[30px] rounded-3xl border border-black shadow-amber-400 
    transition-opacity duration-1000 ease-out 
    group-hover:opacity-100 group-hover:pointer-events-auto 
    flex justify-center items-center">
    
    {token ? (
      <button onClick={logoutHandler} className="text-black cursor-pointer">LogOut</button>
    ) : (
      <button onClick={() => navigate('/')} className="text-black cursor-pointer">Signup</button>
    )}
  </div>
</div>
